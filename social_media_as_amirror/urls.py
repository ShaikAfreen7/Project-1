"""social_media_as_amirror URL Configuration
...
from social_media_as_amirror import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Mental_Health_Type/$', remoteuser.Predict_Mental_Health_Type, name="Predict_Mental_Health_Type"),
    ...
    url(r'^View_Predicted_Mental_Health_Type_Ratio/$', serviceprovider.View_Predicted_Mental_Health_Type_Ratio, name="View_Predicted_Mental_Health_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Predicted_Mental_Health_Type_Details/$', serviceprovider.View_Predicted_Mental_Health_Type_Details, name="View_Predicted_Mental_Health_Type_Details"),
